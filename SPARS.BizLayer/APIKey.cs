// -----------------------------------------------------------------------
// <copyright file="APIKey.cs" company="Visionary Computer Solutions">
...
namespace SSS.BizLayer
{
    ...
    /// TODO: Update summary.
    /// </summary>
    public class APIKey : DBEntity, IDBEntity
    {
        ...
        /// TODO: Update summary.
        /// </summary>
        public APIKey(DBConnector connection)
        {
            this.SetupDBEntity();
        }
        ...
        {
            if (string.IsNullOrEmpty(APIKey.TableName))
            {
                APIKey.TableName = "APIKey";
            }

            if (string.IsNullOrEmpty(APIKey.PrimaryKeyName))
            {
                APIKey.PrimaryKeyName = "KeyNo";
            }

            if (string.IsNullOrEmpty(APIKey.EndingPropertyName))
            {
                APIKey.EndingPropertyName = "ModDate";
            }

            if (APIKey.DBProperties == null)
            {
                APIKey.DBProperties = new List<PropertyInfo>(this.GetType().GetProperties());
            }

            if (string.IsNullOrEmpty(APIKey.InsertQueryStart))
            {

                string query = string.Empty;

                this.PrepareQueries(this, APIKey.TableName, APIKey.EndingPropertyName, ref query, APIKey.DBProperties);

                APIKey.InsertQueryStart = query;
            }
        }
        ...
        public bool GetList(string criteria, string fields, ref DataTable data, string orderby = "")
        {
            ...
            {
                query = "SELECT * FROM [" + APIKey.TableName + "]";
            }
            else
            {
                query = "SELECT " + fields + " FROM [" + APIKey.TableName + "]";
            }
        ...
        public bool GetViewList(string criteria, string fields, ref DataTable data, string orderby = "")
        {
            ...
            if (string.IsNullOrEmpty(fields))
            {
                query = "SELECT * FROM [VW_" + APIKey.TableName + "]";
            }
            else
            {
                query = "SELECT " + fields + " FROM [VW_" + APIKey.TableName + "]";
            }
        ...
        public int GetMax()
        {
            ...
            if (!this.GetList(string.Empty, "MAX(" + APIKey.PrimaryKeyName + ")", ref data))
            {
                return maxNo;
            }
        ...
        /// TODO: Update summary.
        /// </summary>
        public bool GetObject(int KeyNo)
        {
            this.KeyNo = KeyNo;
            return this.GetObjectFromQuery(this.PrepareGetObjectQuery(this, "VW_" + APIKey.TableName, APIKey.PrimaryKeyName));
        }
        ...
        public bool GetObject(string PropertyName, string PropertyValue)
        {
            ...
            return this.GetObjectFromQuery(this.PrepareGetObjectQuery(this, "VW_" + APIKey.TableName, PropertyName));
        }
        ...
        public bool GetObjectFromQuery(string query)
        {
            ...
            this.PopulateObject(this, data, APIKey.DBProperties, APIKey.EndingPropertyName);
        ...
        public Result SaveNew()
        {
            ...
            try
            {
                this.KeyNo = this.GetMax();
                l_Query = this.PrepareUpdateQuery(this, ("Temp_" + APIKey.TableName), ("Temp" + APIKey.PrimaryKeyName), APIKey.EndingPropertyName, APIKey.DBProperties);
        ...
        public bool Modify()
        {
            ...
            try
            {
                query = this.PrepareUpdateQuery(this, APIKey.TableName, APIKey.PrimaryKeyName, APIKey.EndingPropertyName, APIKey.DBProperties);
        ...
        public bool DeleteAll(string groupNos)
        {
            ...
            try
            {
                query = this.PrepareDeleteAllQuery(APIKey.TableName, APIKey.PrimaryKeyName, groupNos);
        ...
        // '' TODO: Update summary.
        // '' </summary>
        public Result Delete(int p_KeyNo)
        {
            ...
            try
            {
                ...
                l_Query = "EXEC sp_APIKey_Delete ";
                PublicFunction.FieldToParam(this.KeyNo, ref l_Param, PublicFunction.FieldTypes.Number);
                l_Query += " " + l_Param;
        ...
        public Result PreSaveChecks()
        {
            ...
            try
            {
                l_Query = "EXEC sp_APIKey_PreSaveCheck";
                PublicFunction.FieldToParam(this.TempKeyNo, ref l_Param, PublicFunction.FieldTypes.Number);
                l_Query += " " + l_Param;
